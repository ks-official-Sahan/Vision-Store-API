...
public class CreateFirstUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (userDTO.getName().isEmpty()) {
            ...
            responseDTO.setStatus(false);
        } else if (userDTO.getRole().equals("select")) {
            responseDTO.setMessage("Role is required");
            ...
            if (!criteria1.list().isEmpty()) {
                ...
                MailSender mailSender = new MailSender(user.getEmail(), "Vision Store Admin", user.getVerification());
                mailSender.start();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        resp.getWriter().write("Create First User");
    }
}
